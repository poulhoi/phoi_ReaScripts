--[[
@description phoi_Auto-increment file name of next render and open render settings
@author Poul Høi
@links 
...
-- NAME
local scriptName = 'phoi_Auto-increment file name of next render and open render settings'
