--[[
@description phoi_Render selected area of tracks, muting items - stereo, post-fader
@author Poul Høi
@links 
...
-- USER CONFIG
act_id = 41716 -- render action id

-- NAME
({reaper. get_action_context()})[2]:match("([^/\\]+)%.lua$") -- generate default scriptName from file
