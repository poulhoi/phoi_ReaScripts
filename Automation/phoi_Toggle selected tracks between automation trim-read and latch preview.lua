--[[
@description phoi_Toggle selected tracks between automation trim-read and latch preview
@author Poul Høi
@links 
...
local onMode = 5 -- "target mode" when is toggle is on

-- NAME
local scriptName = "phoi_Toggle selected tracks between automation trim-read and latch preview"
