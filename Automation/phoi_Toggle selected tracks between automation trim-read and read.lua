--[[
@description phoi_Toggle selected tracks between automation trim-read and read
@author Poul Høi
@links 
...
local onMode = 1 -- "target mode" when is toggle is on

-- NAME
local scriptName = "phoi_Toggle selected tracks between automation trim-read and read"
