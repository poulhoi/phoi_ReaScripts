--[[
@description phoi_Toggle selected tracks between automation trim-read and touch
@author Poul Høi
@links 
...
local onMode = 2 -- "target mode" when is toggle is on

-- NAME
local scriptName = "phoi_Toggle selected tracks between automation trim-read and touch"
